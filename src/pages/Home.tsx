    ...
    <div>
        ...
        <div className="row">
          ...
          <div className="col-md-6">
            <h2 className="cek">
              ...
              <br />Sesuai <span className="beratbadan">Tinggi</span>
            </h2>
            <p className="bmi">
      ...
      <div className="container mt-5">
        <div className="row">
          ...
          >
            <img src="/image/tool1.jpg" height="150px" alt="Gula Darah" />
          ...
          >
            <img src="/image/tool2.jpg" height="150px" alt="Blood Pressure" />
          ...
          <Link
            ...
            className="col-md-2 text-center text-decoration-none"
          >
            <img src="/image/tool5.jpg" height="150px" alt="Calorie Calculator" />
